...
route.post("/user-profile", upload_1.upload.single("foto_profil"), userProfileController_1.default.add);
route.get("/user-profile/:user_id", userProfileController_1.default.get);
