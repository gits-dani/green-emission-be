...
route.post("/user-profile", isAuthenticated_1.isAuthenticated, userProfileController_1.default.add);
route.get("/user-profile", isAuthenticated_1.isAuthenticated, userProfileController_1.default.get);
